...
- **Page layer** (`src/pages/`): one `WeekNPage` per week. Week 11 composes the three real modules; Weeks 12–15 compose `PlaceholderCard`s with the FRD-mandated counts (3 / 4 / 3 / 2).
